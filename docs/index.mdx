...
- [Baryon Desktop 1.2.0 release notes](/public/desktop/release-notes): review new control, rendering, TouchDesigner, and output behavior before upgrading a show setup.
- [Program output](/public/desktop/program-output): send Performer to a display, Syphon, or Spout.
...
- **Desktop** — the downloadable performance app: program output, Baryon Pro licensing, parameter automation, and OSC structure export.
