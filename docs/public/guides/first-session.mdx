...
| Control              | Use it for                                                                                          |
| -------------------- | --------------------------------------------------------------------------------------------------- |
| **Material Density** | Overall material concentration, thickness, and radiance.                                            |
| **Laser Bending**    | Placement and concentration of laser caustics within the acoustic field.                             |
| **Fresnel Strength** | Amount of grazing-angle laser energy along the field edges.                                         |
| **Color Mode**       | `Static` for controlled color, `Spectral` when you want the audio spectrum to color promoted modes. |

For quiet or sparse material, start lower on **Material Density** and **Fresnel Strength**. Audio-to-field response is calibrated automatically; **Motion Scale** only changes audio-driven rotation.
