...
Good starting controls: lower **Material Density** and **Caustic Strength** for quiet or sparse material. For dense, layered music, try **Spectral** color so the field is colored by the spectrum.
