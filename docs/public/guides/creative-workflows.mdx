...
Good starting controls: lower **Reactivity**, **Density**, and **Opacity** for quiet or sparse material, then raise **Node Threshold** if the field feels too diffuse. For dense, layered music, try **Spectral** color so the field is colored by the spectrum.
