...
control-change hardware. Open Performer Mode, open **Control Input**, enable
control input, and enable the transports you want.
...
4. In Baryon, enable **Control Input** and **MIDI**, then select the IAC bus
   under **Input**.
