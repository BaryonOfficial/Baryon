...
| Label              | Description                                                                                            |
| ------------------ | ------------------------------------------------------------------------------------------------------ |
| **Extent**         | Keep the field contained in the flagship sphere, or let the waves radiate past it and fade into space. |
...
| **Refraction**     | How strongly the laser bends through the acoustic pressure field — higher values focus tighter webs.   |
