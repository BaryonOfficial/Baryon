    ...
    <main className="desktop-shell">
      <section className="desktop-shell__hero">
        ...
        <p className="desktop-shell__lede">
          The legacy desktop visualizer surface has been removed. This app is
          now a clean starting point for building the native desktop experience.
        </p>
      </section>
      ...
      <section className="desktop-shell__panel">
        ...
        <ul className="desktop-shell__list">
          ...
          <li>
            No legacy Three.js, audio, or desktop-only visualizer code
            remaining.
          </li>
        </ul>
      </section>
      ...
      <section className="desktop-shell__panel">
        ...
        <ul className="desktop-shell__list">
          <li>
            Add Tauri commands in Rust and call them from the React shell.
          </li>
          <li>
            Introduce native window controls, filesystem access, or updater
            flows as needed.
          </li>
          <li>
            Layer the actual desktop product UI on top of this shell instead of
            reviving old web code.
          </li>
        </ul>
      </section>
      ...
      <section className="desktop-shell__panel desktop-shell__panel--links">
        ...
        <p className="desktop-shell__copy">
          Distributed builds should make the repo and licensing terms easy to
          verify.
        </p>
