  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Baryon is licensed under AGPL-3.0-only in the public repo, with a
          separate commercial license for proprietary embedding, OEM,
          white-label, and client delivery.
        </p>
        <div
          style={{
            display: "flex",
