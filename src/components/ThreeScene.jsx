...
const ThreeScene = () => {
  const { loaded: ringbufLoaded, error: ringbufError } = useScript('/ringbuf.js');
  ...
  }, [ringbufLoaded, ringbufError]);

  // Render your component or return null if the script is not yet loaded
  if (!ringbufLoaded) return <div>Loading...</div>;
  if (ringbufError) return <div>Error loading the script!</div>;
