...
import type { ParticlesMaterialImpl, ParticlesMaterialProps, ParticlesProps } from '@/types/particles'
...
declare module '@react-three/fiber' {
  ...
  export default function Particles({ gpgpu, geometries, parameters, audioObject }: ParticlesProps) {
