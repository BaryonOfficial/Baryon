...
import sty from "./PlasmicButton.module.css"; // plasmic-import: gPE0fa_Hm6Wn/css
import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: cLrQMAMaTgbx/icon
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__gi7T)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg___573Qn)}
                role={"img"}
              />
            ),
