...
function logNodeConnections() {
    console.log('SoundGainNode -> Essentia Node:', audioObject.soundGainNode.connect(audioObject.essentiaNode));
    console.log('Essentia Node -> Gain Node:', audioObject.essentiaNode.connect(audioObject.gain));
    console.log('Gain Node -> Destination:', audioObject.gain.connect(audioObject.audioCtx.destination));
}
