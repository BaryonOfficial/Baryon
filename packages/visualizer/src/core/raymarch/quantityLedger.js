...
export const RAYMARCH_QUANTITY_LEDGER = Object.freeze({
  ...
  spectralDisplayProjection: createQuantityContract({
    ...
    surface: "material-transfer",
    represents:
      "display RGB derived from spectral lane radiance after material transfer, density shaping, and entropy-aware projection",
    deepOwner: "material.js spectral lane-to-display transfer",
    transforms: [
      "lane texture sampling",
      "dominance and entropy shaping",
      "display RGB projection",
      "material density transfer",
    ],
    allowedConsumerPath: [
      "material spectral lane transfer",
      "scene radiance",
  ...
  materialExcitationGate: createQuantityContract({
    ...
    transforms: [
      "structure signal",
      "modal response energy",
      "modal coefficient energy",
      "mode coherence",
    ],
    allowedConsumerPath: [
      "material transfer",
      "body density and hot-core mix",
      "diagnostics",
    ],
    allowedConsumers: ["bodyDensity", "hotCoreMix", "diagnostics"],
    forbiddenConsumers: [
      "causticRidgeAuthority",
      "highlightMask",
      "whiteEmissionFieldAuthority",
...
export const RAYMARCH_RENDER_SURFACE_AUDITS = Object.freeze({
  ...
  materialSpectralLaneProjection: createSourceSurfaceAudit({
    surface: "materialSpectralLaneProjection",
    file: "material.js",
    owner: "spectralDisplayProjection",
    startToken: "function projectSpectralLaneRadianceToRgbNode({",
    endToken: "function createScatteringNode({",
    requiredTokens: [
  ...
  materialExcitationAuthority: createSourceSurfaceAudit({
    surface: "materialExcitationAuthority",
    file: "material.js",
    owner: "materialExcitationGate",
    startToken: "const excitationInput =",
    endToken: "const latchedFogMask =",
    requiredTokens: [
      "uStructureSignal",
      "uModalResponseEnergy",
      "modalCoefficientEnergy",
      "uModeCoherence",
      "excitationModalAuthority",
    ],
    forbiddenTokens: [
      "uAverageAmplitude",
      "RAYMARCH_AVERAGE_AMPLITUDE_SHADER_REFERENCE",
      "excitationSourceAuthority",
    ],
  }),
